...
const VISUAL := {"tint": Color("#f0dfce"), "background": "res://assets/art/terrain_only/city_qin_terrain_only.png", "map_hint": "秦制县城纵深更广，可左右拖动巡视县廷与传舍", "identity": {"earth": Color(0.20, 0.17, 0.15, 0.72), "standard": Color("#26211f"), "motif": "qin_road"}}
