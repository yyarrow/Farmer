...
const VISUAL := {"tint": Color("#eee5dc"), "background": "res://assets/art/terrain_only/city_jin_terrain_only.png", "map_hint": "晋代州城临河铺展，可左右拖动巡视坞壁、津市与都督军府", "identity": {"earth": Color(0.38, 0.30, 0.25, 0.66), "standard": Color("#95594c"), "motif": "river_gate"}}
