...
const VISUAL := {"tint": Color("#fff4e4"), "background": "res://assets/art/terrain_only/city_warring_states_terrain_only.png", "map_hint": "战国城郭已扩展，可左右拖动巡视自由营造区", "identity": {"earth": Color(0.37, 0.24, 0.17, 0.66), "standard": Color("#963e35"), "motif": "rammed_earth"}}
