...
const VISUAL := {"tint": Color("#dce8df"), "background": "res://assets/art/terrain_only/city_song_terrain_only.png", "map_hint": "宋代州城沿河开市，可左右拖动巡视圩田、厢坊、转般仓、军寨和城外草市", "identity": {"earth": Color(0.34, 0.40, 0.36, 0.72), "standard": Color("#4f6f68"), "motif": "river_market"}}
