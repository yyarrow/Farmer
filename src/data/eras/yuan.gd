...
const VISUAL := {"tint": Color("#d9e4df"), "background": "res://assets/art/terrain_only/city_yuan_terrain_only.png", "map_hint": "元代路城沟通草原与漕河，可左右拖动巡视屯田、站赤马院、官仓、诸色户坊和万户府", "identity": {"earth": Color(0.35, 0.39, 0.38, 0.74), "standard": Color("#327174"), "motif": "steppe_station"}}
