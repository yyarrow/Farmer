...
const CITY_LEVELS := [
	...
	{"level": 2, "name": "坞堡", "slots": 9, "advance_target": 480, "view_scale": 1.10},
	{"level": 3, "name": "郡县治", "slots": 12, "advance_target": 665, "view_scale": 1.20},
	{"level": 4, "name": "州府", "slots": 12, "advance_target": 865, "view_scale": 1.30},
	{"level": 5, "name": "州郡重城", "slots": 12, "advance_target": 1080, "view_scale": 1.40},
]
...
const VISUAL := {"tint": Color("#e6e5dc"), "background": "res://assets/art/terrain_only/city_three_kingdoms_terrain_only.png", "map_hint": "魏郡坞城与军屯铺展，可左右拖动巡视军仓、武库和马苑", "identity": {"earth": Color(0.29, 0.28, 0.25, 0.70), "standard": Color("#344c60"), "motif": "palisade"}}
