...
2026年7月20日的`0.16.0`全朝代标准建筑候选验证结果：AAB 140.5 MiB，SHA-256 `35a13ae738ee6e29d8e2e1d5651a25403dad8a6eb9c9255296620c8a0a50a5b4`；独立 APK 140.6 MiB，SHA-256 `8a0d65dbda6cb886016018764a5140bae7b46f1fb043a7c5d5e23465e864cab9`；上传证书延续为 SHA-256 `62837ae6fb7a7281d5ef5f39dcd9189db0ef8e1075b237a9e7f93a86e8eaae1f`。两个包均通过版本19/0.16.0、签名、权限、arm64单架构、16 KiB页面/ZIP对齐、RELRO、竖屏、主题图标、字体许可和开发文件排除检查，AAB另通过bundletool，Android lint仍为固定20条模板警告。十四时代×八建筑的112套发行图集全部统一为四个384×384阶段帧，只允许等比缩放和平移；448帧边缘串色为0，均登记显式入口接点，农田地面容差合计9像素且每帧均在硬阈值内。120套旧时代/根目录图集保留在仓库作比较但已从三个Android预设排除。真实渲染重新覆盖十四时代空/半/满城42张，元代城防另覆盖1—5级和12建筑满城；南墙23组相交均在建筑前景，北墙41组相交均在建筑后景，城门道路连续且12座容量不变。最终APK在Android 35 ARM64模拟器覆盖安装后冷启动为232毫秒，存档首页和退出弹窗均无世界贴图穿透，进程日志无崩溃、脚本或资源缺失错误。
