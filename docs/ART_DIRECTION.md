...
十四个时代各有八套建筑成长图，通过内置图像生成工具以对应时代纯地形骨架作为首要构图与透视参考，再使用项目标准色键工具移除纯色背景。最终素材位于 `assets/art/buildings/eras/<时代>/*_stages.png`。战国已额外完成统一 384×384 阶段框、2×2/3×2/3×3/4×2 标准菱形基座、落地点和入口方向的全套标准化建筑；城垣素材只供独立城防的城门与墙段表现，不再作为普通建筑占用槽位。
